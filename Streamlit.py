...
chemin_caracteristiques = "caracteristiques_concat_2019_2023.csv"
chemin_vehicules = "vehicules_concat_2019_2023.csv"
chemin_lieux = "lieux_concat_2019_2023.csv"
chemin_usagers = "usagers_concat_2019_2023.csv"
chemin_fusion = "datasets_fusionnes.csv"
chemin_avant_machine_learning = "datasets_filtre_avant_machine_learning.csv"
...
df_fusion = charger_donnees(chemin_fusion)
...
if page == pages[1] : 
  ...
  st.image("jointures des tables.jpg", caption="Les 4 datasets avec leurs liaisons", use_column_width=True)
...
if page == pages[4] : 
  ...
  with tab2:
    st.header("Data visualisation réalisée sous PowerBI")
    st.image("Analyse Temporelle par année.jpg", caption="Nombre d'accidents par an", use_column_width=True)
    ...
    st.image("Nb_accidents_par annee_2005_2023.jpg", caption="Nombre d'accidents par an de 2005 à 2023 - Histogramme réalisé sous Python avec Seaborn", use_column_width=True)
    ...
    st.image("Analyse Temporelle par mois.jpg", caption="Nombre d'accidents par mois", use_column_width=True)
    ...
    st.image("Analyse Temporelle par jour.jpg", caption="Nombre d'accidents par jour", use_column_width=True)
    ...
    st.image("Analyse Temporelle par créneau horaire.jpg", caption="Nombre d'accidents par créneau horaire", use_column_width=True)
  ...
  with tab3:
    ...
    st.image("répartition des accidents graves selon genre  agglo et type vehicule.jpg", caption="Zoom sur la gravité",  use_column_width=True)
    ...
    st.image("Top 10 départements avec le plus d'accidents graves.jpg", caption="Zoom sur la gravité",  use_column_width=True)
...
if page == pages[6] : 
  ...
  st.image("Features Importance avec LightGBM 2.png",caption="Histogramme des Features Importance du modèle LightGBM", use_column_width=True) 
...
if page == pages[8] : 
  ...
  st.image("prevision SARIMA.jpg", use_column_width=True)
